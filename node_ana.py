...
file1_pattern = config.get('Patterns', 'file1_pattern')
file2_pattern = config.get('Patterns', 'file2_pattern')
...
def get_latest_file(pattern):
    ...
    if not matched_files:
        raise FileNotFoundError(f"No files matching {pattern} found in {downloads_path}")
...
# Fetch latest files dynamically based on patterns from config
